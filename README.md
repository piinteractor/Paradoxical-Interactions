...
- [[Framework]] - The core concepts
- [[Examples]] - PI in action across domains
- [[Practices]] - Navigation tools and guidance
...
**This project was assembled in co-creation with artificial intelligence.**

Without AI, this site would not exist.  
Without my expertise and authorship, it would not exist either.

What you see here is not automation.  
It is interaction.

This didn't emerge from asking the right questions. It emerged by staying inside the wrong ones.

**— Peter Senner (HI, but not definitively sure)**

---

**Quote**: "All are guilty, none are at fault"  
**Contact**: contact@piinteract.org  
**Website**: https://piinteract.org
