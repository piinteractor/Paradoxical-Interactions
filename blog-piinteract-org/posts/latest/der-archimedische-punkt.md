...
["Unvollständigkeit akzeptieren"] — Genau die Lücke, die keiner der beiden Beobachter allein schließen kann, ist der Ort, an dem das Zwei-Idioten-Theorem tatsächlich arbeitet.
...
Relativity: The Special and the General Theory (1917) — Einsteins eigener Text, Kapitel III: die Originalstelle, in der er sich selbst als Beobachter im Zug einführt, bevor der zweite Beobachter überhaupt auftaucht.

On the Electrodynamics of Moving Bodies (1905) — Die Originalarbeit, in der Einstein die eine geteilte Invariante festlegt, auf der jede Übersetzung zwischen Bezugssystemen beruht: die Konstanz der Lichtgeschwindigkeit.
