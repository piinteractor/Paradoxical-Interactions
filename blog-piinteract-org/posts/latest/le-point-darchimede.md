...
modified: 2026-08-02T13:55:54
slug: le-point-darchimede
lang: fr
type: post
status: publish
wp_id: 8727
url: https://blog.piinteract.org/fr/le-point-darchimede/
---

Pourquoi la physique a besoin de deux observateurs pour fonctionner — et pourquoi aucun des deux ne voit jamais ce que voit l'autre.
...
L'IP du point d'Archimède : Toute médiation entre deux perspectives closes produit l'illusion d'un tiers qui verrait les deux à la fois — alors même que ce tiers est impossible dans la structure qu'on décrit.

Tous agissent rationnellement :

Le professeur de physique — dessine les deux référentiels dans un seul schéma (sans compression, pas de compréhension)

Le lecteur — accepte le point de vue du schéma (sans lui, pas d'orientation)

Résultat — une physique qui interdit l'observateur externe, et une pédagogie qui le suppose sans le dire

Tous sont coupables. Personne n'y peut rien.

Ce que cela change

Pas : supprimer les schémas. Ils restent utiles, comme les cartes restent utiles même si aucun paysage ne ressemble à ça vu d'en haut. Ce qui change, c'est la question qu'on pose à toute mise en regard — pas seulement en physique. Qui raconte, là, « des deux points de vue » ? Le point de vue incarné de qui vient d'être déclaré point de vue de personne ? Toute comparaison entre deux systèmes, tout « vu des deux côtés », tout « objectivement parlant » porte en lui le même point d'Archimède qui n'existe pas. On ne peut pas le supprimer. On peut seulement le nommer.

Le vocabulaire que deux observateurs doivent trouver pour se comprendre n'est jamais un regard commun. C'est une invariante commune — un seul point sur lequel les deux peuvent compter sans jamais le vérifier de l'extérieur. Chez Einstein, c'est la vitesse de la lumière. Le reste n'est que traduction.
...
["Accepter l'incomplétude"] — L'écart exact qu'aucun des deux observateurs ne peut combler seul est précisément l'endroit où le théorème des deux idiots se met au travail.

["Reconnaître l'angle mort partagé"] — Le point d'Archimède est l'angle mort que partagent l'enseignant et l'élève : tous deux en ont besoin, aucun ne peut le justifier.

["Nommer le paradoxe"] — Le schéma ne disparaît pas une fois nommé. Mais on cesse de prendre son tiers pour un véritable observateur.

Voir aussi (sources externes) :

Relativity: The Special and the General Theory (1917) — Le texte d'Einstein lui-même, chapitre III : le passage original où il se présente comme l'observateur du train, avant même que le second observateur n'apparaisse.

On the Electrodynamics of Moving Bodies (1905) — L'article original, où Einstein fixe l'unique invariante partagée dont dépend toute traduction entre référentiels : la constance de la vitesse de la lumière.

K-calculus in 4-dimensional optics (arXiv) — Formalise la méthode de Bondi : deux observateurs, seulement des signaux lumineux, aucune scène commune d'où les deux seraient visibles à la fois.

Conventionality of Simultaneity — Stanford Encyclopedia of Philosophy : le débat toujours non tranché sur la question de savoir si « simultané » peut être défini indépendamment d'une convention.