...
status: publish
wp_id: 8192
url: https://blog.piinteract.org/fr/la-verite-parallele/
---
...
Havel appelle cela vivre dans le mensonge. La formule induit en erreur si on la lit moralement. L'épicier ne ment à personne. Il accroche une pancarte. La vérité — qu'il n'y croit pas, que personne dans la rue n'y croit, que toute la ville le sait — existe en permanence, non dissimulée, accessible à quiconque regarde. Elle se tient à côté de la vérité officielle comme une seconde vitrine dans la même rue.

Le système n'a pas besoin de réfuter cette vérité parallèle. Il n'existe aucun lieu où une réfutation pourrait avoir lieu. Son code ne demande pas « y croit-il ». Il demande « la pancarte est-elle accrochée ». Cette question trouve toujours une réponse, toujours claire, toujours disponible. La seconde question ne se pose jamais, parce qu'elle n'a jamais été prévue dans le système d'exploitation.
...
Personne dans cette chaîne n'a eu besoin de mentir. La BaFin protège l'ordre du marché et les émetteurs cotés — c'est sa mission légale, et elle la remplit en repoussant les attaques contre le cours de bourse. Une enquête qui menace le cours ressemble, depuis l'intérieur de cette mission, à une attaque, non à un avertissement. EY suit des normes d'audit qui doivent s'appuyer sur l'honnêteté de la direction, car sans cette confiance, aucun audit ne pourrait être achevé dans un délai raisonnable — c'est la méthode, non la négligence. Les journalistes du FT enquêtaient en dehors du code réglementaire, et tout ce qui s'enquête en dehors du code se présente à ce code comme une perturbation, non comme une contribution.

Chaque acteur a traité correctement la vérité parallèle — selon son propre critère. Aucun ne disposait d'une catégorie capable de distinguer « ceci pourrait être une vraie fraude » de « ceci est une attaque contre une entreprise qui fonctionne », avant que le dommage ne soit déjà là. La vérité n'attendait pas d'être trouvée. Elle attendait qu'un organe existe, capable de la lire.

L'IP de la vérité parallèle : Une structure n'a pas besoin de réfuter une vérité qui la contredit. Elle doit seulement ne jamais la laisser prendre une forme à laquelle elle puisse réagir.

Tout le monde agit rationnellement :

La BaFin — protège l'ordre du marché et les émetteurs (mission légale) → traite l'enquête comme une attaque contre l'ordre, non comme un avertissement

EY — suit des normes d'audit qui doivent faire confiance aux déclarations de la direction (c'est la méthode) → enregistre les relevés manquants comme un retard, non comme une fiction

Les journalistes du FT — enquêtent en dehors du code réglementaire → sont classés comme manipulateurs de marché, non comme témoins

Résultat — structurel, non intentionnel : 1,9 milliard d'euros de comptabilité fictive restent des années à côté du bilan certifié, sans contradiction et sans traitement
...
La transparence seule ne résout pas cela. La transparence suppose qu'un organe soit prêt à recevoir ce qui est révélé. Sans cet organe, la transparence ne produit qu'une vérité de plus, non traitée — plus visible qu'avant, et tout aussi inefficace. La navigation ne commence pas par exiger plus d'ouverture. Elle commence par demander quelle catégorie manque — et qui serait capable de la créer, avant que l'effondrement ne l'impose.

Ceci n'est pas un mode d'emploi. Il n'existe pas cinq étapes pour installer, dans une structure, une entrée qu'elle n'a jamais prévue. Ce qui reste, c'est un déplacement de la question : non pas « pourquoi personne ne voit-il cela », mais « pour quoi n'existe-t-il tout simplement aucune rubrique ici ».
...
["Ce que tu ne sais pas ne peut pas te faire de mal"] — La BaFin et EY ne savaient pas ce qu'ils étaient structurellement incapables de savoir. L'expression décrit exactement ce piège, pas un confort recherché.
...
The Power of the Powerless — Le texte original de Havel, 1978 : la source de l'exemple de la vitrine et de l'idée de vivre dans une contradiction sans avoir besoin d'y croire.

Rapport final de la 3e commission d'enquête (Wirecard), BT-Drs. 19/30900 — Le rapport officiel du Bundestag : plus de deux mille pages reconstituant comment la BaFin, l'auditeur et la supervision ont classé les signaux d'alerte pendant des années au lieu de les traiter.

What are the wider supervisory implications of the Wirecard case? — Étude institutionnelle du Parlement européen sur les lacunes structurelles de la supervision — pas sur le cas individuel, mais sur l'entrée manquante elle-même.
