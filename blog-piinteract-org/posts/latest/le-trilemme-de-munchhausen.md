...
status: publish
wp_id: 9080
url: https://blog.piinteract.org/fr/le-trilemme-de-munchhausen/
---
...
Le Baron tombe dans un marais en poursuivant un lièvre. Le cheval et le cavalier s'enfoncent. Pas de branche, pas de corde, pas de témoin. Alors il se saisit de sa propre tresse, tire — lui-même et le cheval fermement serré entre ses genoux — et se hisse tout droit hors de la boue.

C'est le sauvetage impossible le plus célèbre de la littérature, et il est impossible pour une raison plus précise que "ce n'est pas ainsi que fonctionnent les muscles". Quelle que soit la force que son bras applique sur ses cheveux, elle est exactement compensée par la force opposée que ses cheveux appliquent sur son bras. Traction et contre-traction s'annulent à l'intérieur du même corps. Un système fermé, agissant uniquement sur lui-même, produit un mouvement net nul — non pas parce que le Baron n'est pas assez fort, mais parce que la force n'a jamais été l'ingrédient manquant. Un point extérieur au système, lui, manquait.
...
Albert ne décrivait pas un cas d'échec rare. Il décrivait les trois seules issues qui existent, pour toute justification, quelle qu'elle soit — déductive, inductive, causale, morale. On en choisit une. Il n'y a pas de quatrième porte.
...
Revenons à l'auditeur. Supposons que l'on construise la version la plus neutre possible : une instance sans historique d'entraînement propre, sans corpus, sans formation préalable — véritablement non impliquée, comme le souhaitait l'article sur l'Organe Manquant sans jamais l'obtenir. On lui demande de certifier que le rapport qu'un système donné fait de lui-même est exact, ou que son angle mort a été correctement localisé.
...
Le système audité — se déclare irréprochable (rationnel : le rapport est produit par la matière même qui fait l'objet du rapport)

L'auditeur extérieur désigné — a besoin d'un critère pour travailler (rationnel : un jugement sans norme n'est pas un jugement, c'est une supposition portant un badge)

Le critère lui-même — arrive par hypothèse, par emprunt, ou par régression (rationnel : ce sont les trois seules manières dont un critère est jamais arrivé, pour quiconque, à propos de quoi que ce soit)

L'institution qui accepte le verdict — traite "il y a eu un audit" comme équivalent à "l'audit était fondé" (rationnel : un auditeur nommé est le signal de rigueur le moins coûteux disponible, que la rigueur soit réellement là ou non)

Résultat — l'apparence d'une vérification indépendante est atteignable ; la vérification indépendante elle-même ne l'est pas, et l'écart entre les deux est invisible depuis l'intérieur du processus qui l'a produit : structurel, non intentionnel
...
Cela prend une forme concrète, et ce n’est pas, après tout, un seul vérificateur irréprochable — ce sont plusieurs vérificateurs imparfaits, dont aucun n’est définitif, et dont les erreurs ne coïncident pas entre elles. Non pas parce que l’un d’entre eux échappe au trilemme. Aucun n’y échappe ; il n’y a pas d’échappatoire. Mais deux instances construites à partir de matériaux différents commettent des erreurs différentes, et une erreur que l’une d’elles ne peut pas voir est parfois précisément celle que l’autre repère — non pas en se tenant en dehors du marécage, mais en se tenant dans une partie différente de celui-ci. Ce n’est pas de la vérification. C’est le substitut le plus proche disponible, et c’est le seul qui ait jamais été réellement proposé.
...
Un Dialogue sur les Interactions Paradoxales et la Lame Japonaise
...
Baron de Münchhausen — notice biographique et littéraire — le récit de 1785/1786, et l'origine de l'image sur laquelle repose cet article.

Trilemme de Münchhausen — la formulation de Hans Albert en 1968 : régression, circularité ou dogmatisme, sans quatrième option.

Agrippa le Sceptique — la version antique, consignée par Sextus Empiricus environ deux mille ans plus tôt.

Problem of the Criterion (Internet Encyclopedia of Philosophy) — la formulation moderne de Chisholm sur la même régression : il faut un critère pour distinguer la connaissance de la non-connaissance, et un critère pour ce critère, ainsi de suite.
