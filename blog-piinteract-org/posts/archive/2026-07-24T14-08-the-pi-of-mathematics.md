...
status: publish
wp_id: 8113
url: https://blog.piinteract.org/the-pi-of-mathematics/
---
...
The Pythagoreans wanted to build the world out of ratios of whole numbers. Everything was supposed to be rational — in both senses of the word. Then the diagonal of the unit square landed at their feet: √2. No ratio, anywhere. Legend has it they drowned the man who found it. The number stayed. The number space expanded to include the irrational — forced open by the very attempt to keep it rational.
...
Three times, the same structure:

The intent is rational. Wanting completeness isn't malicious — it wants clarity, reliability, solid ground. The Pythagoreans, the algebraists, Hilbert: not dogmatists, but precision workers.

The result is inversion. The very claim to closure exposes exactly where the system doesn't close. √2 exists as a scandal only because everything was supposed to be rational. Gödel's theorems exist because Hilbert demanded completeness — they are the precise answer to a precise question that would never have been asked without the will to close.
...
If mathematics were a closed game, Hinton would be right: you could play it out like Go. Self-posed problems, checked proofs, reward for winning. Much of that will work — within the rules.

But mathematics is not rule-following. Historically, verifiably, it is the event where the rules stop being enough. The moment √2 shows up. The moment someone takes the imaginary unit seriously. The moment someone poses the completeness question so precisely that the answer moves the foundation itself.

An AI that learns mathematics as a closed system learns the game. Whether it learns the moment when the game blows itself open is an open question — quite literally: a question that cannot be settled from within the system it concerns.
...
Geoffrey Hinton in conversation with Yascha Mounk — Full interview transcript, primary source for Hinton's claim that mathematics is a "closed system."

Gödel's Incompleteness Theorems – Stanford Encyclopedia of Philosophy — The formal, peer-reviewed account of both incompleteness theorems underlying the Hilbert section.

Pythagoras – MacTutor History of Mathematics (University of St Andrews) — Institutional source for the historical account of the Pythagoreans' discovery of the irrational.
