---
title: "Warum Objektivität nicht objektiv sein kann. Der Beobachter, der nicht da ist.y^"
date: 2026-04-28T15:42:45
modified: 2026-06-04T17:26:39
slug: warum-objektivitaet-nicht-objektiv-sein-kann
lang: de
type: post
status: publish
wp_id: 5452
url: https://blog.piinteract.org/de/warum-objektivitaet-nicht-objektiv-sein-kann/
---
...
Ein Wissenschaftler misst die Temperatur einer Flüssigkeit. Das Thermometer verändert die Temperatur der Flüssigkeit. Ein Journalist berichtet über eine Demonstration. Der Bericht verändert die Demonstration. Ein Teamleiter bewertet ein Team. Die Bewertung verändert das Team. In jedem Fall besteht der Beobachter auf Objektivität. In jedem Fall ist die Beobachtung bereits eine Intervention.
...
Aber es gibt eine zweite Richtung. Und sie ist die schärfere.
...
Wer sich mit Paradoxen Interaktionen beschäftigt, sieht irgendwann nur noch paradoxe Interaktionen.

Beide Richtungen zusammen erzeugen eine Wechselwirkung ohne stabilen Ausgangspunkt. Der Beobachter verändert das Beobachtete — das veränderte Beobachtete verändert wiederum den Beobachter — der veränderte Beobachter beobachtet anders — das Beobachtete verändert sich wieder. Kein fester Referenzpunkt. Keine neutrale Nulllage. Keine Objektivität — nicht einmal als regulative Idee.

Von Foerster hat das nicht ausformuliert. Vermutlich nicht, weil er es nicht sah — sondern weil die zweite Richtung seinen eigenen Rahmen aufgelöst hätte. Kybernetik zweiter Ordnung setzt noch einen Beobachter voraus, der beobachtet. Einer, der seinerseits geformt wird durch das, was er beobachtet, ist kein Beobachter mehr im klassischen Sinn. Das Messsystem kollabiert. Der wissenschaftliche Betrieb — das Beobachtete, das Von Foerster täglich beobachtete — hatte ihn bereits geformt. Er konnte nur so weit gehen, wie die Struktur es zuließ.
...
Von Foerster kam nicht zu dem Schluss, dass alle Perspektiven gleich sind, dass Wahrheit unmöglich ist oder dass Genauigkeit sinnlos ist. Er zog eine anspruchsvollere Schlussfolgerung: dass der Beobachter in die Beschreibung einbezogen werden muss. Diese Ehrlichkeit erfordert, dass man den Standpunkt, von dem aus man sieht, darlegt.

Das ist schwieriger als Objektivität. Objektivität ist eine Haltung - sauber, glaubwürdig, über den Dingen stehend. Eine anerkannte Perspektive erfordert Offenheit. Sie erfordert, dass man sagt: Ich sehe das von hier aus, mit diesen Instrumenten, geprägt von diesen Interessen und diesen Grenzen. Das ist es, was ich anbieten kann.

PI erhebt keinen Anspruch auf Objektivität. Es beansprucht strukturelle Konsistenz - was etwas anderes ist. Ein Framework kann an sich selbst getestet werden. Entweder es hält, oder es hält nicht. Der Test lautet nicht: Kommt es aus dem Nichts? Der Test lautet: Gilt es für sich selbst?

Das tut es. Dieser Beitrag ist aus dem Inneren der Struktur geschrieben, die er beschreibt.

Navigation, nicht Lösung. Der Beobachter kann nicht heraus treten. Aber zu wissen, wo man steht, ist nicht nichts.
