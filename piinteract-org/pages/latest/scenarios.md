...
modified: 2026-05-03T10:06:42
slug: scenarios
lang: fr
type: page
status: publish
wp_id: 1491
url: https://piinteract.org/fr/pratiques-de-pi/scenarios/
---
...
Vous êtes dans : Une IP d'irrationalité collective
...
Vous êtes dans : Une IP auto-renforçante
...
Vous êtes dans : Une IP de contrainte structurelle
...
Vous êtes dans : Une IP de paradoxe d'information
...
Vous êtes dans : Une IP de paradoxe d'effort
...
Vous êtes dans : Une IP d'asymétrie structurelle
...
Vous êtes dans : Une IP de paradoxe de sécurité
...
Vous êtes dans : Une IP pilotée par le succès
...
Vous êtes dans : Une IP d'échec de coordination
...
Vous êtes dans : Une IP de paradoxe réglementaire
...
Tu es dans: Une IP de reconnaissance hiérarchique
...
Tu es dans: Une IP de protection de chambre d'écho
...
Tu es dans: Une IP de positions incompatibles
...
Tu es dans: Une IP de légitimation ésotérique
...
Tu es dans: Une IP d'élimination du messager
...
Leurs armes contre la IP (et comment les nommer les désarme):

1. Rejet réductionniste « Ce n'est que [théorie des systèmes/théorie des jeux/dialectique] avec un nouveau nom. » Réalité: La IP est synthèse, pas réemballage. La structure est distincte.

2. Appropriation sans attribution « Nous disons cela depuis des années. » [Utilise les concepts IP sans crédit] Réalité: Si c'est évident, pourquoi ne l'avez-vous pas formalisé ? La documentation compte.
...
5. Arme poppérienne « Pas falsifiable, donc pas scientifique. » Réalité: La IP décrit des schémas, pas des lois. La falsifiabilité s’applique aux prédictions, pas aux observations.
...
9. Déni d’originalité « Rien de nouveau ici. Bateson/Luhmann/Girard ont déjà couvert cela. » Réalité: La IP synthétise et applique. L’innovation n’est pas seulement l’invention – c’est l’intégration.
...
11. Intégration sans tranchant « Ajout intéressant aux cadres existants… » Réalité: La IP n’est pas complémentaire. Elle est fondamentale. L’intégra
