...
The same capacity that produces the insight prevents its reception. The person who sees the structural problem clearly enough to name it precisely has already exceeded the threshold the group can process. Precision reads as arrogance. Clarity reads as condescension. The sharper the analysis, the more it confirms the social verdict: Smart-aleck. The instrument that diagnoses the situation is the same instrument that makes the diagnosis unreceivable.
