...
Jedes hinreichend komplexe System enthält Wahrheiten, die es von innen nicht beweisen kann (Gödel, strukturell übertragen — siehe Two-Idiot Theorem). Wer auf das vollständige Bild wartet, bevor er handelt, wartet für immer. Die Lücke ist kein Defekt, den man beheben muss. Sie ist die Bedingung, unter der hier überhaupt etwas funktioniert.
